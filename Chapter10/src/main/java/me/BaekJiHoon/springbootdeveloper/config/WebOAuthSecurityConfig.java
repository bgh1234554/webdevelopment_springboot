...
import me.BaekJiHoon.springbootdeveloper.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import me.BaekJiHoon.springbootdeveloper.config.oauth.OAuth2SuccessHandler;
import me.BaekJiHoon.springbootdeveloper.config.oauth.OAuth2UserCustomService;
...
public class WebOAuthSecurityConfig {
    ...
    public WebSecurityCustomizer configure(){
        ...
        //스프링 시큐리티가 적용되지 않는 코드를 만든다.
        //특정 리소스나 URL에 대해 시큐리티 검사를 하지 않도록 설정하기 위해서입니다.
    }
...
/*
    OAuth2에 필요한 정보를 세션이 아니라 쿠키에 저장해 쓸 수 있도록 인증 요청과 관련된 상태를 저장할 저장소를 구현 예정.
    config/oauth 내에
    OAuth2AuthorizationRequestBasedOnCookieRepository.java 파일을 생성.
 */